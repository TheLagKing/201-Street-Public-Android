...
function onLoad()
{
	lines = CoolUtil.coolTextFile(Paths.getPath('songs/music-for-your-ears!/lyrics.txt', null, null, true));
	lines.insert(0, '');
}
...
function onCreatePost()
{
	...
	lyric_text.setFormat(Paths.font("Neuzeit.otf"), 20, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
{
	FlxTween.cancelTweensOf(lyric_text);
	lyric_text.alpha = 0;
	if (moveY)
	{
		lyric_text.y = 520;
