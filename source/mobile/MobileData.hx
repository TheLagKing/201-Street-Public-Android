...
class MobileData
{
	...
	public static function init()
	{
		...
		readDirectory(Paths.getCorePath('mobile/DPadModes'), dpadModes);
		readDirectory(Paths.getCorePath('mobile/ActionModes'), actionModes);
		#if MODS_ALLOWED
		for (folder in directoriesWithFile(Paths.getCorePath(), 'mobile/'))
		{
